...
export const defaultCmsDocument: CmsDocument = {
  ...
  mission: {
    ...
    proposalEyebrow: "Project proposal",
    proposalTitle: "Read the proposal",
    proposalText: "The proposal is provided as a document and opens directly as a PDF.",
    proposalButton: "Open proposal",
  },
  who: {
    eyebrow: "Who we are",
